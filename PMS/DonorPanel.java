...
public class DonorPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DonorPanel window = new DonorPanel();
	...
	private void initialize() {
		...
		JLabel lblPatientPanel = new JLabel("Donor Panel");
		lblPatientPanel.setFont(new Font("Times New Roman", Font.PLAIN, 32));
		lblPatientPanel.setForeground(Color.RED);
		lblPatientPanel.setBounds(395, 52, 274, 34);
		...
		JLabel lblPendingAppointments = new JLabel("Upcoming Donation Request");
		lblPendingAppointments.setFont(new Font("Times New Roman", Font.PLAIN, 22));
		lblPendingAppointments.setBounds(44, 294, 282, 25);
		frame.getContentPane().add(lblPendingAppointments);
		
		JLabel lblCompletedAppointments = new JLabel("Completed Donation Request");
		...
		lblNoRecordFound.setBounds(112, 342, 307, 16);
		...
		label_1.setBounds(112, 463, 357, 16);
		frame.getContentPane().add(label_1);
		
		JLabel lblBadges = new JLabel("Badges");
		lblBadges.setFont(new Font("Times New Roman", Font.PLAIN, 22));
		lblBadges.setBounds(888, 294, 97, 25);
		frame.getContentPane().add(lblBadges);
		
		JLabel lblNotifications = new JLabel("Notifications");
		lblNotifications.setFont(new Font("Times New Roman", Font.PLAIN, 22));
		lblNotifications.setBounds(888, 410, 258, 25);
