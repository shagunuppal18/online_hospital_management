...
public class DonorRegistration {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DonorRegistration window = new DonorRegistration();
	...
	private void initialize() {
		...
		JLabel lblPatientRegistration = new JLabel("Donor Registration");
		...
		JLabel lblPatientName = new JLabel("Donor Name");
		...
		JLabel lblLocationcity = new JLabel("Blood Group");
